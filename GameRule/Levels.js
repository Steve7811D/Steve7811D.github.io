var Levels=[
    ...
    },
    {
        ...
        load:function(){
            ...
            //Terran buildings
            new Building.TerranBuilding.CommandCenter({x:0,y:1020}).life=375;
    ...
    },
    {
        ...
        load:function(){
            ...
            if (!isNightmare){
                //Make it easy
                Hero.DevilHunter.prototype.HP[0]=9999;
                Hero.DevilHunter.prototype.SP[0]=9999;
                Hero.DevilHunter.prototype.MP[0]=999;
                Hero.DevilHunter.prototype.damage[0]=50;
            ...
            Levels.enemyWave=function(){
                var pos={isEnemy:true};
                _$.traverse([Neutral,Zerg,Terran,Protoss],function(enemyType){
                    pos.x=(Math.random()*mapSize.width)>>0;
                    pos.y=(Math.random()*mapSize.height)>>0;
