var Upgrade={
    ...
    UpgradeGroundWeapons:{
        ...
        effect:function(isEnemy){
            ...
            //New RPG level
            Hero.DevilHunter.prototype.damage[Number(Boolean(isEnemy))]+=2;
            this.level[Number(Boolean(isEnemy))]++;
    ...
    UpgradeGroundArmor:{
        ...
        effect:function(isEnemy){
            ...
            //New RPG level
            Hero.DevilHunter.prototype.armor[Number(Boolean(isEnemy))]+=2;
            this.level[Number(Boolean(isEnemy))]++;
    ...
    UpgradePlasmaShields:{
        ...
        effect:function(isEnemy){
            ...
            //New RPG level
            Hero.DevilHunter.prototype.plasma[Number(Boolean(isEnemy))]+=2;
            this.level[Number(Boolean(isEnemy))]++;
