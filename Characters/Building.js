    ...
    prototypePlus: {
        ...
        items: {
            ...
            '7':{name:'ComstatStation',condition:function(){
                return (!Game.selectedUnit.attachment || Game.selectedUnit.attachment.status=='dead') && Building.ourBuildings.some(function(chara){
        ...
        buildTerranBuilding:function(){
            ...
            var construction=new (eval('Building.'+target.prototype.evolves[0].step))
                ({x:this.x+this.width,y:this.y+this.height-target.prototype.height,isEnemy:this.isEnemy});
