...
Gobj.prototype.evolveTo=function(props){
    //Init
    var charaType=props.type,burstArr=props.burstArr,mixin=props.mixin;
    var newTypeChara=null,selectedStatus=[this.selected,(this==Game.selectedUnit)];
